...
class AreaDAO
{
    public function readArea(){
        ...
        try { $sql = ('SELECT * FROM tb_area ORDER BY id');
    ...
    public function createArea($area){			
		...
		try { $sql = "INSERT INTO tb_area (initials, name) VALUES (:initials, :name)";
    ...
    public function updateArea($area) {
        ...
        try { $sql = ('UPDATE tb_area SET initials = :initials, name = :name WHERE id = :id');
    ...
    public function deleteArea($id) {        
        ...
        try { $sql = ('DELETE FROM tb_area WHERE id = :id');
    ...
    public function readAreaByName($name){
        ...
        try { $sql = ('SELECT * FROM tb_area WHERE name = :name');
            $instance = DatabaseConnection::getInstance();
            $conn = $instance->getConnection();
            $statement = $conn->prepare($sql);
    ...
    public function readAreaByInitials($initials){
        ...
        try { $sql = ('SELECT * FROM tb_area WHERE initials = :initials');
            $instance = DatabaseConnection::getInstance();
            $conn = $instance->getConnection();
            $statement = $conn->prepare($sql);
